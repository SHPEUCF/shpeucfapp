    ...
    if(this.state.toggle){
      if(this.props.screen1 != null){
        ...
        return(
          ...
          backgroundColor:'#96e4ff'}}>
          <Text style={{textAlign:'center', padding:50}}>Please use the tag screen1 to pass a view for this screen.</Text>
          </View>
        );
      }
    }
      ...
      if(this.props.screen2 != null){
        ...
        return(
          ...
          alignItems:'center'}}>
          <Text style={{textAlign:'center', padding:50}}>Please use the tag screen2 to pass a view for this screen.</Text>
          </View>
        );
      }
    }
    ...
    <View style={{flex:0, flexDirection:'row', justifyContent:'center',}}>
      <TouchableOpacity onPress={() => {this.setState({toggle: !this.state.toggle})}}
        style={{flex:0,
          ...
          justifyContent:'center'}}>
        <Text style={{fontWeight:'900',color:textColorLeft, textAlign:'center'}}>{this.props.leftText!=null?this.props.leftText:"Screen 1"}</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => {this.setState({toggle: !this.state.toggle})}}
        style={{flex:0,
          borderWidth:2,
