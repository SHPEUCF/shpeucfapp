...
class SegmentBtn extends Component {
	...
	render() {
		const textColorLeft = this.state.toggle ? "white" : this.props.color ? this.props.color : "blue";
		const textColorRight = this.state.toggle ? this.props.color ? this.props.color : "blue" : "white";
		const btnBackColorLeft = this.state.toggle ? this.props.color ? this.props.color : "blue" : "white";
		const btnBackColorRight = this.state.toggle ? "white" : this.props.color ? this.props.color : "blue";
				...
				<View style = {{ flex: 0, flexDirection: "row", justifyContent: "center" }}>
					...
					>
						<Text style = {{ fontWeight: "900", color: textColorLeft, textAlign: "center" }}>
							{ this.props.leftText ? this.props.leftText : "Screen 1" }
						</Text>
					</TouchableOpacity>
					<TouchableOpacity onPress = { () => { this.setState({ toggle: !this.state.toggle }) } }
						style = {{ flex: 0,
						...
						<Text	style = {{ fontWeight: "900", color: textColorRight, textAlign: "center" }}>
							{ this.props.rightText ? this.props.rightText : "Screen 2" }
						</Text>
					</TouchableOpacity>
				</View>
				<View style = {{ flex: 1 }}>
