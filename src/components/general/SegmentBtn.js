...
class SegmentBtn extends Component {
  ...
  render() {
    const textColorLeft = this.state.toggle
      ? "white"
      : this.props.color != null
      ? this.props.color
      : "blue";
    const textColorRight = this.state.toggle
      ? this.props.color != null
        ? this.props.color
        : "blue"
      : "white";
    const btnBackColorLeft = this.state.toggle
      ? this.props.color != null
        ? this.props.color
        : "blue"
      : "white";
    const btnBackColorRight = this.state.toggle
      ? "white"
      : this.props.color != null
      ? this.props.color
      : "blue";
