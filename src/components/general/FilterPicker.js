...
class FilterPicker extends Component {
  ...
  selectUserAction(user) {
    ...
    if (tmpSelectedNames[`${user.id}`]) tmpSelectedNames[`${user.id}`] = undefined;
    else tmpSelectedNames[`${user.id}`] = user.id;

    this.setState({ selectedNames: tmpSelectedNames });
  }
  ...
  renderComponent(item, index) {
    if (this.props.type === "Single") {
      ...
      if (re.test(`${user.firstName} ${user.lastName}`)) {
        return (
          <TouchableOpacity onPress={() => this.clickAction(user, index)}>
      ...
      if (re.test(`${user.firstName} ${user.lastName}`)) {
        return (
          <TouchableOpacity onPress={() => this.selectUserAction(user)}>
          ...
          <Modal transparent={true} visible={this.state.modalVisible}>
            <View style={modalBackground}>
              <View style={modalStyle}>
                ...
                <Input style={[inputStylee, inputStyleee]} onChangeText={onChangeText} value={this.props.filter} />
            ...
            <View style={modalBackground}>
              <View style={modalStyle}>
                ...
                <View style={buttonContainer}>
                  ...
                  <TouchableOpacity style={buttonStyle} onPress={() => this.props.onClose()}>
                    <Text style={textStyle}>Cancel</Text>
                  </TouchableOpacity>
                </View>
              </View>
