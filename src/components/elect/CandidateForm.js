...
class CandidateForm extends Component {
  ...
  onButtonPress() {
    const { firstName, lastName, candidatePlan, applyPosition } = this.props;
  ...
  renderButtons() {
    ...
    return (
      <View style={buttonContainer}>
        ...
        <Button title="CANCEL" onPress={Actions.ElectionCandidates.bind(this)} />
      </View>
    );
  }

  render() {
    const { formContainerStyle, headerStyle, headerTextStyle, content, textColor } = styles;
    return (
