...
class LoginForm extends Component {
  ...
  renderResetPassword() {
    const { resetPasswordText, bottomContainer } = styles;
    return (
      <TouchableOpacity style={bottomContainer} onPress={this.props.goToResetPassword}>
  ...
  renderSignUpButton() {
    ...
    return (
      <View style={bottomContainer}>
        ...
        <TouchableOpacity onPress={this.props.goToRegistration}>
  ...
  renderContent() {
    const { formContainerStyle, headerContainer, headerTitle, headerTextStyle, headerSubtitleStyle } = styles;

    return (
      <View style={formContainerStyle}>
        <ScrollView style={{ flex: 1.5, paddingTop: 10 }}>
          <Image source={require("../../assets/images/SHPE_UCF_Logo.png")} style={{ alignSelf: "center" }} />
