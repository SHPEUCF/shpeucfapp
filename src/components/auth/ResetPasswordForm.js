...
class ResetPasswordForm extends Component {
  ...
  ResetPasswordButton() {
    return <Button title="RESET" onPress={this.onButtonPress.bind(this)} />;
  }
...
const styles = StyleSheet.create({
  ...
  loginButton: { color: "#000", flexDirection: "row", justifyContent: "center", color: "white" }
});
...
const mapDispatchToProps = { emailChanged, resetPassword, goToLogIn };
