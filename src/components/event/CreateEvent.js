...
class CreateEvent extends Component {
  ...
  componentWillMount() {
    if (this.props.name !== "") this.props.titleChanged("Edit Event");
  }
  ...
  onTypeChange(text) {
    ...
    if (text === "Social Event") this.onPointsChange(3);
    else if (text === "Volunteer Event") this.onPointsChange(3);
    else if (text === "GBM") this.onPointsChange(5);
    else if (text === "Workshop") this.onPointsChange(3);
    else if (text === "Committee") this.onPointsChange(2);
    else this.onPointsChange("");
  }
  ...
  renderComponent(item) {
    ...
    last = item[0] == dataArr[dataArr.length - 1] ? { borderBottomColor: "#0000" } : {};
    return (
            ...
            <View style={modalBackground}>
              <View style={modalStyle}>
                ...
                <View style={buttonContainer}>
                  <TouchableOpacity style={buttonStyle} onPress={() => this.setState({ modalVisible: false })}>
      ...
      <View style={styles.formContainerStyle}>
        ...
        <ScrollView ref={ref => (this.scrollView = ref)} style={styles.scrollView}>
          <View>
            ...
            />
            {this.showCommittees()}
            <Input placeholder="Name" value={this.props.name} onChangeText={this.onNameChange.bind(this)} />
            <Input
            ...
            />
            <DatePicker placeholder={"Date"} value={this.props.date} onSelect={text => this.onDateChange(text)} />
            <TimePicker placeholder={"Time"} value={this.props.time} onSelect={text => this.onTimeChange(text)} />
            <Input
            ...
            <Input
              placeholder="Value"
              value={
                this.props.points === 0 || this.props.points === undefined ? "" : this.props.points.toString()
              }
        ...
        {this.renderError()}
        <Button title={this.props.title} onPress={this.onButtonPress.bind(this)} />
        <Button title="CANCEL" onPress={this.props.goToEvents.bind(this)} />
      </View>
    );
  }
}
