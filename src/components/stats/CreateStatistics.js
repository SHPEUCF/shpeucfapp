...
const obj = { keys1: "k1", keys2: "k2", keys3: "k3" };

let filters = [];
for (k in obj) filters.push(k.key);
  ...
  render() {
    return (
      <View style={styles.formContainerStyle}>
        ...
        <View></View>
        <Button title="CREATE STATISTICS" onPress={this.onButtonPress.bind(this)} />
        <Button title="CANCEL" onPress={Actions.popTo.bind(this, "Statistics")} />
      </View>
    );
  }
}
