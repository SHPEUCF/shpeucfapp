  ...
  renderFlatlist(committees) {
    return (
      <FlatList
        ...
        renderItem={({ item, separator }) => this.renderCommittees(item)}
      />
    );
  }
...
const mapDispatchToProps = { getCommittees };
