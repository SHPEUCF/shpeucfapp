...
class ElectionBackEnd extends Component {
  ...
  openOrClose() {
    ...
    else return <Button onPress={() => this.props.openElection()} title={"OPEN ELECTION"}></Button>;
  }

  applyOpenOrClose() {
    if (this.props.apply)
      return <Button onPress={() => this.props.closeApplications()} title={"CLOSE APPLICATIONS"}></Button>;
    else return <Button onPress={() => this.props.openApplications()} title={"OPEN APPLICATIONS"}></Button>;
  }
