...
class CheckIn extends Component {
  ...
  componentWillMount() {
    const region = { identifier: "SHPEUCF_RadBeacon_Dot", uuid: "2F234454-CF6D-4A0F-ADF2-F4911BA9FFA6" };
  ...
  render() {
    const { cardContainer, eventInfoContainer, eventInfoRow, infoLabel, infoValue, signalInfoLabel } = styles;
          ...
          <Card title="First GBM" containerStyle={cardContainer}>
            ...
            {this.state.beacons.map((beacon, i) => (
              <View key={i} style={{ marginBottom: 10 }}>
                ...
                <Text style={{ fontSize: 15, fontWeight: "bold", marginBottom: 10 }}>Beacon Information</Text>
