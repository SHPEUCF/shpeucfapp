...
class Profile extends Component {
      ...
      <View style={{ flex: 1 }}>
        <ScrollView style={{ backgroundColor: "#0c0b0b" }}>
          ...
          <View style={bioContainer}>
            ...
            <View style={taglineContainer}>
              <Text style={[itemLabelText, textColor, { flex: 1 }]}>(Quote): {quote}</Text>
            </View>
          </View>
  ...
  renderPicture() {
    ...
    return (
      <View style={headerInfoContainer}>
        <Avatar size={200} rounded source={{ uri: picture }} onPress={() => this.openGallery()} />
      </View>
    );
  }
  ...
  renderButtons() {
    const { buttonsContainerStyle } = styles;
    return (
      <View style={buttonsContainerStyle}>
        <Button title="EDIT PROFILE" onPress={this.props.goToEditProfileForm.bind(this)} />
        <Button title="LOG OUT" onPress={this.props.logoutUser.bind(this)} />
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  taglineContainer: { flex: 0.2, alignItems: "center", marginTop: dimension.height * 0.02 },
  fieldContainerStyle: { flex: 0.2, flexDirection: "row" },
  itemLabelText: {
    flex: 0.25,
    fontSize: 18,
    fontWeight: "bold",
  ...
  itemValueContainerStyle: { flex: 4, flexDirection: "row", justifyContent: "center", alignItems: "flex-start" },
  itemValueText: { flex: 1, fontSize: 16, fontWeight: "500", color: "#fff" },
  buttonsContainerStyle: {
    flex: 0.4,
    marginRight: dimension.height * 0.015,
    marginLeft: dimension.height * 0.015,
    height: dimension.height * 0.145
  },
  LogoContainer: {
    flex: 1,
  ...
  bioContainer: { flex: 1, backgroundColor: "#2C3239", paddingLeft: "5%" },
  socialmediatext: { flex: 1, alignSelf: "center" }
});
...
const mapDispatchToProps = { loadUser, logoutUser, goToEditProfileForm, pageLoad, pictureChanged };
